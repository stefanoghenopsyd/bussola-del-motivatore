...
La motivazione al lavoro non è un elemento statico, ma un **sistema integrato** dove convivono tre grandi aree: 
* **Fattori Intrinseci:** la spinta che nasce dal piacere e dal dovere interno.
* **Fattori Estrinseci:** le leve esterne, i premi e la struttura.
* **Fattori di Clima:** l'ossigeno delle relazioni e dell'appartenenza.

Un buon leader deve saper orchestrare queste leve con pesi differenti. Questa autovalutazione ti aiuterà a riconoscere la tua **"bussola" personale** e a riflettere su come orienti il tuo team.
---
""")
